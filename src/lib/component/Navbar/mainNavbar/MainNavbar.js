    ...
    <div className="w-full">
            ...
            <div className="items-center hidden gap-1 lg:flex">
              <Link href="/" className="group relative px-5 py-2.5 rounded-xl transition-all duration-300">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-semibold transition-all duration-300 group-hover:font-bold" style={{ color: 'var(--primary-800)' }}>
                    Products
                  </span>
                </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t shadow-2xl lg:hidden" style={{ borderColor: 'var(--primary-100)' }}>
        <div className="flex items-center justify-around px-4 py-3">
          {/* Shop */}
          <Link href="/" className="flex flex-col items-center gap-1 p-2 transition-all duration-300 rounded-xl active:scale-95">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl" style={{ backgroundColor: 'var(--primary-50)' }}>
          ...
          <Link href="/pages/wishlist" className="flex flex-col items-center gap-1 p-2 transition-all duration-300 rounded-xl active:scale-95">
            <div className="relative flex items-center justify-center w-10 h-10 rounded-xl" style={{ backgroundColor: 'var(--primary-50)' }}>
              <span className="text-xl">❤️</span>
          ...
          {/* Cart */}
          <Link href="/pages/cart" className="flex flex-col items-center gap-1 p-2 transition-all duration-300 rounded-xl active:scale-95">
            <div className="relative flex items-center justify-center w-10 h-10 rounded-xl" style={{ backgroundColor: 'var(--primary-50)' }}>
          ...
          {/* Deals */}
          <Link href="/pages/deals" className="relative flex flex-col items-center gap-1 p-2 transition-all duration-300 rounded-xl active:scale-95">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl" style={{ backgroundColor: 'var(--primary-50)' }}>
              <span className="text-xl">🔥</span>
            </div>
      ...
      {/* Spacing for fixed navbar - REMOVED THE EXTRA SPACER */}
    </div>
  )
}