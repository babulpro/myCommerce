        ...
        <div>
            <div className="dropdown dropdown-end">
                <div className="relative">
                        ...
                        <div className="relative">
                            <div className="w-10 h-10 overflow-hidden rounded-xl ring-2" style={{ 
                                ...
                                <div className="flex items-center justify-center w-full h-full" style={{ 
                                    ...
                                    <span className="text-lg" style={{ color: 'var(--primary-700)' }}>👤</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Login Dropdown */}
                    <div tabIndex={0} className="z-50 p-0 mt-3 bg-white border shadow-2xl w-80 dropdown-content rounded-2xl" style={{ borderColor: 'var(--primary-100)' }}>
                        {/* Login Header */}
